...
<title>src/Player.java · main · courses / 2025 / 09 / COMPSCI2212 / group16 · GitLab</title>
<script>
//<![CDATA[
...
gl.startup_graphql_calls = [{"query":"query getBlobInfo(\n  $projectPath: ID!\n  $filePath: [String!]!\n  $ref: String!\n  $refType: RefType\n  $shouldFetchRawText: Boolean!\n) {\n  project(fullPath: $projectPath) {\n    __typename\n    id\n    repository {\n      __typename\n      empty\n      blobs(paths: $filePath, ref: $ref, refType: $refType) {\n        __typename\n        nodes {\n          __typename\n          id\n          webPath\n          name\n          size\n          rawSize\n          rawTextBlob @include(if: $shouldFetchRawText)\n          fileType\n          language\n          path\n          blamePath\n          editBlobPath\n          gitpodBlobUrl\n          ideEditPath\n          forkAndEditPath\n          ideForkAndEditPath\n          codeNavigationPath\n          projectBlobPathRoot\n          forkAndViewPath\n          environmentFormattedExternalUrl\n          environmentExternalUrlForRouteMap\n          canModifyBlob\n          canModifyBlobWithWebIde\n          canCurrentUserPushToBranch\n          archived\n          storedExternally\n          externalStorage\n          externalStorageUrl\n          rawPath\n          replacePath\n          pipelineEditorPath\n          simpleViewer {\n            fileType\n            tooLarge\n            type\n            renderError\n          }\n          richViewer {\n            fileType\n            tooLarge\n            type\n            renderError\n          }\n        }\n      }\n    }\n  }\n}\n","variables":{"projectPath":"courses/2025/09/COMPSCI2212/group16","ref":"main","refType":"HEADS","filePath":"src/Player.java","shouldFetchRawText":true}}];
...
if (gl.startup_graphql_calls && window.fetch) {
  const headers = {"X-CSRF-Token":"OvS3JVmfnrZNDluyDFiOBLaw2mIzZfvN-vpYmjlDE0tplrdJEF7nCrhPxA47Qjc9Vwtg-OTCjt9zFmYUstCpqg","x-gitlab-feature-category":"source_code_management"};
...
gl = window.gl || {};
gl.snowplowStandardContext = {"schema":"iglu:com.gitlab/gitlab_standard/jsonschema/1-1-7","data":{"environment":"self-managed","source":"gitlab-rails","correlation_id":"01KBNSGZYDNGQYP719WHZN50H1","plan":"free","extra":{},"user_id":"a5wF32uTSwbsLgQFwizI3I6nCKbmV9RiXN1+xf1gyoQ=","global_user_id":"SqVlc0dydtgn48vwSe/4Gb2gpSLm8F/tstt1wBtHuFs=","user_type":"human","is_gitlab_team_member":null,"namespace_id":5985,"ultimate_parent_namespace_id":132,"project_id":4405,"feature_enabled_by_namespace_ids":null,"realm":"self-managed","instance_id":"5a96c8ed-b36c-4deb-9ba7-8dfe9ea01ef8","unique_instance_id":"b2256a90-ae5a-54a1-83d4-29aefcadd498","host_name":"gitlab.sci.uwo.ca","instance_version":"18.5.2","context_generated_at":"2025-12-04T23:00:31.469Z"}}
...
<meta content="src/Player.java · main · courses / 2025 / 09 / COMPSCI2212 / group16 · GitLab" property="og:title">
...
<meta content="https://gitlab.sci.uwo.ca/courses/2025/09/COMPSCI2212/group16/-/blob/main/src/Player.java?ref_type=heads" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="src/Player.java · main · courses / 2025 / 09 / COMPSCI2212 / group16 · GitLab" property="twitter:title">
...
<meta name="csrf-token" content="v-naLkDLfwCF8cevTfN2rqdy4HrejT4ZjkjGiYk7gQHsi9pCCQoGvHCwWBN66c-XRsla4AkqSwsHpPgHAqg74A" />
<meta name="csp-nonce" />
...
<div data-blob-path="src/Player.java" data-can-download-code="true" data-escaped-ref="main" data-full-name="courses / 2025 / 09 / COMPSCI2212 / group16" data-has-revs-file="false" data-original-branch="main" data-project-path="courses/2025/09/COMPSCI2212/group16" data-ref-type="heads" data-resource-id="gid://gitlab/Project/4405" data-target-branch="ssures46-main-patch-31432" data-user-id="gid://gitlab/User/1354" id="js-view-blob-app">
...
//<![CDATA[
  window.gl = window.gl || {};
  window.gl.webIDEPath = '/-/ide/project/courses/2025/09/COMPSCI2212/group16/edit/main/-/src/Player.java'
